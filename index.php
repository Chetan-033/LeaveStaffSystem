...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>MCA-Sem-2 Project</title>

	<!-- Site favicon -->
	<link rel="apple-touch-icon" type="image/png" sizes="180x180" href="vendors/images/apple.png">
	<link rel="icon" type="image/png" sizes="32x32" href="vendors/images/icon2.png">
	<link rel="icon" type="image/png" sizes="16x16" href="vendors/images/icon1.png">
	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			<div class="brand-logo">
				<a href="login.html">
					<h5>Continuous Internal Leave Tracking System</h5> </a>
				</a>
			</div>
		</div>
	</div>
