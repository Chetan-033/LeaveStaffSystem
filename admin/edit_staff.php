								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="phonenumber" type="text" pattern="[1-9]{1}[0-9]{9}" title="Enter 10 digit Number" class="form-control" required="true" autocomplete="off"value="<?php echo $row['Phonenumber']; ?>">
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<select name="department" class="custom-select form-control" required="true" autocomplete="off">
												<?php
													$query_staff = mysqli_query($conn,"select * from tbldepartments where DepartmentShortName=(select Department from tblemployees  where emp_id = '$get_id')")or die(mysqli_error());
