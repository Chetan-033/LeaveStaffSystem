													...
													<div class="profile-edit-list row">
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																...
																<input name="phonenumber" class="form-control form-control-lg" type="text" pattern="[1-9]{1}[0-9]{9}" title="Enter 10 digit Number" placeholder="" required="true" autocomplete="off" value="<?php echo $row['Phonenumber']; ?>">
															</div>
														</div>
														<div class="weight-500 col-md-6">
															<div class="form-group">
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																...
																<select name="department" class="custom-select form-control" required="true" autocomplete="off">
																	<?php
																		$query_staff = mysqli_query($conn,"select * from tbldepartments where DepartmentShortName=(select Department from tblemployees  where emp_id = '$session_id')")or die(mysqli_error());
