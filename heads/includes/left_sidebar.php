<div class="left-side-bar">
		<div class="brand-logo">
			<a href="index.php">
			 <img src="../vendors/images/icem.png" alt="" class="dark-logo"> -->
			 <img src="../vendors/images/icem.png" alt="" class="light-logo"> -->
			</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<!-- <li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-library"></span><span class="mtext">Add Student</span>
						</a>
						<ul class="submenu">
