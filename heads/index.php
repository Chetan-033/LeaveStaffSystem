...
<body>
	<div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><img src="../vendors/images/desktop.png" alt=""></div>
			...
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						...
						<p class="font-18 max-width-600">You are in ICEM.</p>
					</div>
				</div>
			</div>
			...
			<div class="row pb-10">
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						 ...
						 <?php
						$sql = "SELECT emp_id from tblemployees where role='Staff' and Department=(select Department from tblemployees where emp_id = '$session_id')";
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php
						$status=1;
						$sql = "SELECT id FROM tblleaves WHERE status = :status AND empid IN (SELECT emp_id FROM tblemployees WHERE Department = (SELECT Department FROM tblemployees WHERE emp_id = '$session_id'))";
						$query = $dbh -> prepare($sql);
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php
						$status=2;
						$sql = "SELECT id FROM tblleaves WHERE status = :status AND empid IN (SELECT empid FROM tblemployees WHERE Department = (SELECT Department FROM tblemployees WHERE emp_id = '$session_id'))";
						$query = $dbh -> prepare($sql);
						$query->bindParam(':status',$status,PDO::PARAM_STR);
						$query->execute();
						$results=$query->fetchAll(PDO::FETCH_OBJ);
			...
			<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						...
						<div class="user-list">
							<ul>
								<?php
		                         $query = mysqli_query($conn,"select * from tblemployees where role = 'Staff' AND Department=(SELECT Department FROM tblemployees WHERE emp_id = '$session_id') ORDER BY tblemployees.emp_id desc limit 4") or die(mysqli_error());
					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								<?php $sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.emp_id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status from tblleaves join tblemployees on tblleaves.empid=tblemployees.emp_id WHERE tblemployees.Department = (SELECT Department FROM tblemployees WHERE emp_id = '$session_id') order by lid desc limit 5";
									$query = $dbh -> prepare($sql);
									$query->execute();
									$results=$query->fetchAll(PDO::FETCH_OBJ);
									$cnt=1;
